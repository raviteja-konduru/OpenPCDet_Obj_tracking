# # Install dependencies - Handled in the nautilus Job
...
cd ../
pwd
python train.py --cfg_file cfgs/kitti_models/pv_rcnn_ours.yaml

# Eval Script using the above weights - To Add